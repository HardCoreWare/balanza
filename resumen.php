...
<html>
    ...
    <body class="fixed-left">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0 m-b-30">Seleccionar Parametros Resumen</h4>
                        			...
                        			<div class="row">
                        				...
                        				<div class="col-lg-4">
                        					<form class="form-horizontal" role="form">
                                                ...
                                                <div class="form-group">
	                                                <div class="col-sm-10">
                                                        <input class="btn btn-block" type="button" value="RESUMEN" id="btnSummary">
	                                                </div>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive breakdown" hidden>
                                    
                                    <div class="dropdown pull-right" id="breakdownButton">
                                        <a class="table-close" data-toggle="dropdown" aria-expanded="false">
                                            <i class="fa fa-window-close"></i>
                                        </a>
                                    </div>

                        			<h4 class="header-title m-t-0 m-b-30">DESGLOSE</h4>

                                    <table id="breakdowntable" class="table table-stripped">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                        			...
                        			<h4 class="header-title m-t-0 m-b-30">TABLA</h4>
        ...
        <script src="assets/js/tabledetail.js"></script>
        <script src="assets/js/formsummary.js"></script>
        <script src="assets/js/tablesummary.js"></script>
        <script src="assets/js/requestsummary.js"></script>
